...
public class ReplaceInnerUtil {
    ...
    private static <T extends AbstractJaxb> void execute(T target, java.lang.Object replacement) {
        ...
        case HGROUP:
            ...
            if (replacement instanceof H1 || replacement instanceof H2 || replacement instanceof H3
                    || replacement instanceof H4 || replacement instanceof H5 || replacement instanceof H6) {
                hgroup.getH1OrH2OrH3().add((Inline) replacement);
            }
            if (replacement instanceof List<?>) {
                for (java.lang.Object o : (Collection<? extends java.lang.Object>) replacement) {
                    if (o instanceof H1 || o instanceof H2 || o instanceof H3 || o instanceof H4 || o instanceof H5
                            || o instanceof H6) {
        ...
        case SELECT:
            ...
            if (replacement instanceof Optgroup || replacement instanceof Option) {

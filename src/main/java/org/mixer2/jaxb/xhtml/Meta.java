    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "httpEquiv", buffer, theHttpEquiv);
        }
        {
            String theName;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Meta that = ((Meta) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "httpEquiv", lhsHttpEquiv), LocatorUtils.property(thatLocator, "httpEquiv", rhsHttpEquiv), lhsHttpEquiv, rhsHttpEquiv)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            String theHttpEquiv;
            theHttpEquiv = this.getHttpEquiv();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "httpEquiv", theHttpEquiv), currentHashCode, theHttpEquiv);
        }
        {
            String theName;
            theName = this.getName();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Meta) {
            final Meta copy = ((Meta) draftCopy);
            if (this.isSetHttpEquiv()) {
                String sourceHttpEquiv;
                sourceHttpEquiv = this.getHttpEquiv();
                String copyHttpEquiv = ((String) strategy.copy(LocatorUtils.property(locator, "httpEquiv", sourceHttpEquiv), sourceHttpEquiv));
                copy.setHttpEquiv(copyHttpEquiv);
            } else {
                copy.httpEquiv = null;
            }
            if (this.isSetName()) {
            ...
            if (this.isSetProperty()) {
                ...
                String copyProperty = ((String) strategy.copy(LocatorUtils.property(locator, "property", sourceProperty), sourceProperty));
                copy.setProperty(copyProperty);
            } else {
                copy.property = null;
            }

 ...
 *       &lt;attribute name="border" type="{http://www.w3.org/1999/xhtml}Length" />
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Img) {
            final Img copy = ((Img) draftCopy);
            if (this.isSetSrc()) {
                String sourceSrc;
            ...
            if (this.isSetIsmap()) {
                String sourceIsmap;
                sourceIsmap = this.getIsmap();
                String copyIsmap = ((String) strategy.copy(LocatorUtils.property(locator, "ismap", sourceIsmap), sourceIsmap));
                copy.setIsmap(copyIsmap);
            } else {
                copy.ismap = null;
            }
            if (this.isSetAlign()) {
            ...
            if (this.isSetBorder()) {
                ...
                String copyBorder = ((String) strategy.copy(LocatorUtils.property(locator, "border", sourceBorder), sourceBorder));

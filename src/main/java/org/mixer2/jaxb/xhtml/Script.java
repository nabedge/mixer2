    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theAsync;
            theAsync = this.getAsync();
            strategy.appendField(locator, this, "async", buffer, theAsync);
        }
        {
            String theSpace;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsAsync;
            lhsAsync = this.getAsync();
            String rhsAsync;
            rhsAsync = that.getAsync();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "async", lhsAsync), LocatorUtils.property(thatLocator, "async", rhsAsync), lhsAsync, rhsAsync)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theAsync;
            theAsync = this.getAsync();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "async", theAsync), currentHashCode, theAsync);
        }
        {
            String theSpace;
            theSpace = this.getSpace();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Script) {
            final Script copy = ((Script) draftCopy);
            ...
            if (this.isSetDefer()) {
                String sourceDefer;
                sourceDefer = this.getDefer();
                String copyDefer = ((String) strategy.copy(LocatorUtils.property(locator, "defer", sourceDefer), sourceDefer));
                copy.setDefer(copyDefer);
            } else {
                copy.defer = null;
            }
            if (this.isSetAsync()) {
                String sourceAsync;
                sourceAsync = this.getAsync();
                String copyAsync = ((String) strategy.copy(LocatorUtils.property(locator, "async", sourceAsync), sourceAsync));
                copy.setAsync(copyAsync);
            } else {
                copy.async = null;
            }
            if (this.isSetSpace()) {
                ...
                String copySpace = ((String) strategy.copy(LocatorUtils.property(locator, "space", sourceSpace), sourceSpace));

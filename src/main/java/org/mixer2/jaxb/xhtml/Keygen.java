 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="keytype" type="{http://www.w3.org/2001/XMLSchema}NMTOKENS" />
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean isSetKeytype() {
        return ((this.keytype!= null)&&(!this.keytype.isEmpty()));
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            String theChallenge;
            theChallenge = this.getChallenge();
            strategy.appendField(locator, this, "challenge", buffer, theChallenge);
        }
        {
            List<String> theKeytype;
            theKeytype = (this.isSetKeytype()?this.getKeytype():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof Keygen)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Keygen that = ((Keygen) object);
        {
            String lhsChallenge;
            lhsChallenge = this.getChallenge();
            String rhsChallenge;
            rhsChallenge = that.getChallenge();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "challenge", lhsChallenge), LocatorUtils.property(thatLocator, "challenge", rhsChallenge), lhsChallenge, rhsChallenge)) {
                return false;
            }
        }
        {
            List<String> lhsKeytype;
            lhsKeytype = (this.isSetKeytype()?this.getKeytype():null);
            List<String> rhsKeytype;
            rhsKeytype = (that.isSetKeytype()?that.getKeytype():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            String theChallenge;
            theChallenge = this.getChallenge();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "challenge", theChallenge), currentHashCode, theChallenge);
        }
        {
            List<String> theKeytype;
            theKeytype = (this.isSetKeytype()?this.getKeytype():null);
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Keygen) {
            final Keygen copy = ((Keygen) draftCopy);
            if (this.isSetChallenge()) {
                String sourceChallenge;
                sourceChallenge = this.getChallenge();
                String copyChallenge = ((String) strategy.copy(LocatorUtils.property(locator, "challenge", sourceChallenge), sourceChallenge));
                copy.setChallenge(copyChallenge);
            } else {
                copy.challenge = null;
            }
            if (this.isSetKeytype()) {
                List<String> sourceKeytype;
                sourceKeytype = (this.isSetKeytype()?this.getKeytype():null);
                @SuppressWarnings("unchecked")
                List<String> copyKeytype = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "keytype", sourceKeytype), sourceKeytype));
                copy.unsetKeytype();
                if (copyKeytype!= null) {
                    List<String> uniqueKeytypel = copy.getKeytype();
                    uniqueKeytypel.addAll(copyKeytype);
                }
            } else {
                copy.unsetKeytype();
            }

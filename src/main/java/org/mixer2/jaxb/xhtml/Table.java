 ...
 *       &lt;attribute name="align" type="{http://www.w3.org/1999/xhtml}TAlign" />
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean isSetColgroup() {
        return ((this.colgroup!= null)&&(!this.colgroup.isEmpty()));
    }
    ...
    public boolean isSetTr() {
        return ((this.tr!= null)&&(!this.tr.isEmpty()));
    }
     ...
     *     
     */
    public void setAlign(TAlign value) {
        this.align = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Col> theCol;
            theCol = (this.isSetCol()?this.getCol():null);
            strategy.appendField(locator, this, "col", buffer, theCol);
        }
        {
            List<Colgroup> theColgroup;
            theColgroup = (this.isSetColgroup()?this.getColgroup():null);
        ...
        {
            List<Tbody> theTbody;
            theTbody = (this.isSetTbody()?this.getTbody():null);
            strategy.appendField(locator, this, "tbody", buffer, theTbody);
        }
        {
            List<Tr> theTr;
            theTr = (this.isSetTr()?this.getTr():null);
        ...
        {
            String theBgcolor;
            theBgcolor = this.getBgcolor();
            strategy.appendField(locator, this, "bgcolor", buffer, theBgcolor);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<Col> lhsCol;
            lhsCol = (this.isSetCol()?this.getCol():null);
            List<Col> rhsCol;
            rhsCol = (that.isSetCol()?that.getCol():null);
        ...
        {
            List<Colgroup> lhsColgroup;
            lhsColgroup = (this.isSetColgroup()?this.getColgroup():null);
            List<Colgroup> rhsColgroup;
            rhsColgroup = (that.isSetColgroup()?that.getColgroup():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "colgroup", lhsColgroup), LocatorUtils.property(thatLocator, "colgroup", rhsColgroup), lhsColgroup, rhsColgroup)) {
                return false;
            }
        }
        {
        ...
        {
            List<Tbody> lhsTbody;
            lhsTbody = (this.isSetTbody()?this.getTbody():null);
            List<Tbody> rhsTbody;
            rhsTbody = (that.isSetTbody()?that.getTbody():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "tbody", lhsTbody), LocatorUtils.property(thatLocator, "tbody", rhsTbody), lhsTbody, rhsTbody)) {
                return false;
            }
        }
        {
            List<Tr> lhsTr;
            lhsTr = (this.isSetTr()?this.getTr():null);
            List<Tr> rhsTr;
            rhsTr = (that.isSetTr()?that.getTr():null);
        ...
        {
            String lhsBgcolor;
            lhsBgcolor = this.getBgcolor();
            String rhsBgcolor;
            rhsBgcolor = that.getBgcolor();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bgcolor", lhsBgcolor), LocatorUtils.property(thatLocator, "bgcolor", rhsBgcolor), lhsBgcolor, rhsBgcolor)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<Col> theCol;
            theCol = (this.isSetCol()?this.getCol():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "col", theCol), currentHashCode, theCol);
        }
        {
            List<Colgroup> theColgroup;
            theColgroup = (this.isSetColgroup()?this.getColgroup():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "colgroup", theColgroup), currentHashCode, theColgroup);
        }
        {
            Thead theThead;
            theThead = this.getThead();
        ...
        }
        {
            List<Tbody> theTbody;
            theTbody = (this.isSetTbody()?this.getTbody():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tbody", theTbody), currentHashCode, theTbody);
        }
        {
            List<Tr> theTr;
            theTr = (this.isSetTr()?this.getTr():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tr", theTr), currentHashCode, theTr);
        }
        {
            String theSummary;
            theSummary = this.getSummary();
        ...
        }
        {
            String theBgcolor;
            theBgcolor = this.getBgcolor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bgcolor", theBgcolor), currentHashCode, theBgcolor);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Table) {
            ...
            if (this.isSetCaption()) {
                Caption sourceCaption;
                sourceCaption = this.getCaption();
                Caption copyCaption = ((Caption) strategy.copy(LocatorUtils.property(locator, "caption", sourceCaption), sourceCaption));
            ...
            if (this.isSetCol()) {
                List<Col> sourceCol;
                sourceCol = (this.isSetCol()?this.getCol():null);
                @SuppressWarnings("unchecked")
                List<Col> copyCol = ((List<Col> ) strategy.copy(LocatorUtils.property(locator, "col", sourceCol), sourceCol));
                copy.unsetCol();
                if (copyCol!= null) {
                    List<Col> uniqueColl = copy.getCol();
                    uniqueColl.addAll(copyCol);
                }
            } else {
                copy.unsetCol();
            }
            if (this.isSetColgroup()) {
                List<Colgroup> sourceColgroup;
                sourceColgroup = (this.isSetColgroup()?this.getColgroup():null);
                @SuppressWarnings("unchecked")
                List<Colgroup> copyColgroup = ((List<Colgroup> ) strategy.copy(LocatorUtils.property(locator, "colgroup", sourceColgroup), sourceColgroup));
                copy.unsetColgroup();
                if (copyColgroup!= null) {
                    List<Colgroup> uniqueColgroupl = copy.getColgroup();
                    uniqueColgroupl.addAll(copyColgroup);
                }
            } else {
                copy.unsetColgroup();
            }
            if (this.isSetThead()) {
                Thead sourceThead;
                sourceThead = this.getThead();
                Thead copyThead = ((Thead) strategy.copy(LocatorUtils.property(locator, "thead", sourceThead), sourceThead));
                copy.setThead(copyThead);
            } else {
                copy.thead = null;
            }
            if (this.isSetTfoot()) {
                Tfoot sourceTfoot;
                sourceTfoot = this.getTfoot();
                Tfoot copyTfoot = ((Tfoot) strategy.copy(LocatorUtils.property(locator, "tfoot", sourceTfoot), sourceTfoot));
                copy.setTfoot(copyTfoot);
            } else {
                copy.tfoot = null;
            }
            if (this.isSetTbody()) {
                List<Tbody> sourceTbody;
                sourceTbody = (this.isSetTbody()?this.getTbody():null);
                @SuppressWarnings("unchecked")
                List<Tbody> copyTbody = ((List<Tbody> ) strategy.copy(LocatorUtils.property(locator, "tbody", sourceTbody), sourceTbody));
                copy.unsetTbody();
                if (copyTbody!= null) {
                    List<Tbody> uniqueTbodyl = copy.getTbody();
                    uniqueTbodyl.addAll(copyTbody);
                }
            } else {
                copy.unsetTbody();
            }
            if (this.isSetTr()) {
                List<Tr> sourceTr;
                sourceTr = (this.isSetTr()?this.getTr():null);
                @SuppressWarnings("unchecked")
                List<Tr> copyTr = ((List<Tr> ) strategy.copy(LocatorUtils.property(locator, "tr", sourceTr), sourceTr));
                copy.unsetTr();
                if (copyTr!= null) {
                    List<Tr> uniqueTrl = copy.getTr();
                    uniqueTrl.addAll(copyTr);
                }
            } else {
                copy.unsetTr();
            }
            ...
            if (this.isSetFrame()) {
                ...
                TFrame copyFrame = ((TFrame) strategy.copy(LocatorUtils.property(locator, "frame", sourceFrame), sourceFrame));
            ...
            if (this.isSetRules()) {
                ...
                TRules copyRules = ((TRules) strategy.copy(LocatorUtils.property(locator, "rules", sourceRules), sourceRules));
                copy.setRules(copyRules);
            } else {
                copy.rules = null;
            }
            if (this.isSetCellspacing()) {
                String sourceCellspacing;
                sourceCellspacing = this.getCellspacing();
                String copyCellspacing = ((String) strategy.copy(LocatorUtils.property(locator, "cellspacing", sourceCellspacing), sourceCellspacing));
                copy.setCellspacing(copyCellspacing);
            } else {
                copy.cellspacing = null;
            }
            if (this.isSetCellpadding()) {
                String sourceCellpadding;
                sourceCellpadding = this.getCellpadding();
                String copyCellpadding = ((String) strategy.copy(LocatorUtils.property(locator, "cellpadding", sourceCellpadding), sourceCellpadding));
                copy.setCellpadding(copyCellpadding);
            } else {
                copy.cellpadding = null;
            }
            if (this.isSetAlign()) {
                TAlign sourceAlign;
                sourceAlign = this.getAlign();
                TAlign copyAlign = ((TAlign) strategy.copy(LocatorUtils.property(locator, "align", sourceAlign), sourceAlign));
                copy.setAlign(copyAlign);
            } else {
                copy.align = null;
            }
            if (this.isSetBgcolor()) {
                String sourceBgcolor;
                sourceBgcolor = this.getBgcolor();
                String copyBgcolor = ((String) strategy.copy(LocatorUtils.property(locator, "bgcolor", sourceBgcolor), sourceBgcolor));
                copy.setBgcolor(copyBgcolor);
            } else {
                copy.bgcolor = null;
            }
            if (this.isSetId()) {

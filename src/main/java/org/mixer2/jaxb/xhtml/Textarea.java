 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="wrap" default="soft">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}token">
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theWrap;
            theWrap = this.getWrap();
            strategy.appendField(locator, this, "wrap", buffer, theWrap);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Textarea that = ((Textarea) object);
        {
            String lhsContent;
        ...
        {
            String lhsWrap;
            lhsWrap = this.getWrap();
            String rhsWrap;
            rhsWrap = that.getWrap();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "wrap", lhsWrap), LocatorUtils.property(thatLocator, "wrap", rhsWrap), lhsWrap, rhsWrap)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theWrap;
            theWrap = this.getWrap();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "wrap", theWrap), currentHashCode, theWrap);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Textarea) {
            final Textarea copy = ((Textarea) draftCopy);
            ...
            if (this.isSetCols()) {
                Integer sourceCols;
                sourceCols = this.getCols();
                Integer copyCols = ((Integer) strategy.copy(LocatorUtils.property(locator, "cols", sourceCols), sourceCols));
                copy.setCols(copyCols);
            } else {
                copy.cols = null;
            }
            ...
            if (this.isSetRows()) {
                ...
                Integer copyRows = ((Integer) strategy.copy(LocatorUtils.property(locator, "rows", sourceRows), sourceRows));
            ...
            if (this.isSetWrap()) {
                String sourceWrap;
                sourceWrap = this.getWrap();
                String copyWrap = ((String) strategy.copy(LocatorUtils.property(locator, "wrap", sourceWrap), sourceWrap));
                copy.setWrap(copyWrap);
            } else {
                copy.wrap = null;
            }
            if (this.isSetId()) {

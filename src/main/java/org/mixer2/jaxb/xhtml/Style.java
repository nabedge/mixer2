    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsScoped;
            lhsScoped = this.getScoped();
            String rhsScoped;
            rhsScoped = that.getScoped();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scoped", lhsScoped), LocatorUtils.property(thatLocator, "scoped", rhsScoped), lhsScoped, rhsScoped)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scoped", theScoped), currentHashCode, theScoped);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Style) {
            ...
            if (this.isSetScoped()) {
                String sourceScoped;
                sourceScoped = this.getScoped();
                String copyScoped = ((String) strategy.copy(LocatorUtils.property(locator, "scoped", sourceScoped), sourceScoped));
                copy.setScoped(copyScoped);
            } else {
                copy.scoped = null;
            }
            if (this.isSetId()) {

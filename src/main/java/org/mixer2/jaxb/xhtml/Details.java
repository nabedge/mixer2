    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theOpen;
            theOpen = this.getOpen();
            strategy.appendField(locator, this, "open", buffer, theOpen);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Details that = ((Details) object);
        {
        ...
        {
            String lhsOpen;
            lhsOpen = this.getOpen();
            String rhsOpen;
            rhsOpen = that.getOpen();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "open", lhsOpen), LocatorUtils.property(thatLocator, "open", rhsOpen), lhsOpen, rhsOpen)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theOpen;
            theOpen = this.getOpen();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "open", theOpen), currentHashCode, theOpen);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();

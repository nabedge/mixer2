 ...
 *       &lt;attribute name="type" default="command">
 *         &lt;simpleType>
 ...
 *       &lt;attribute name="icon" type="{http://www.w3.org/1999/xhtml}URI" />
 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="radiogroup" type="{http://www.w3.org/1999/xhtml}Text" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theRadiogroup;
            theRadiogroup = this.getRadiogroup();
            strategy.appendField(locator, this, "radiogroup", buffer, theRadiogroup);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsRadiogroup;
            lhsRadiogroup = this.getRadiogroup();
            String rhsRadiogroup;
            rhsRadiogroup = that.getRadiogroup();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "radiogroup", lhsRadiogroup), LocatorUtils.property(thatLocator, "radiogroup", rhsRadiogroup), lhsRadiogroup, rhsRadiogroup)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theRadiogroup;
            theRadiogroup = this.getRadiogroup();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "radiogroup", theRadiogroup), currentHashCode, theRadiogroup);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Command) {
            final Command copy = ((Command) draftCopy);
            if (this.isSetType()) {
                String sourceType;
            ...
            if (this.isSetRadiogroup()) {
                String sourceRadiogroup;
                sourceRadiogroup = this.getRadiogroup();
                String copyRadiogroup = ((String) strategy.copy(LocatorUtils.property(locator, "radiogroup", sourceRadiogroup), sourceRadiogroup));
                copy.setRadiogroup(copyRadiogroup);
            } else {
                copy.radiogroup = null;
            }

 ...
 *       &lt;attribute name="prompt" type="{http://www.w3.org/1999/xhtml}Text" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Isindex) {
            final Isindex copy = ((Isindex) draftCopy);
            if (this.isSetPrompt()) {
                String sourcePrompt;
                sourcePrompt = this.getPrompt();
                String copyPrompt = ((String) strategy.copy(LocatorUtils.property(locator, "prompt", sourcePrompt), sourcePrompt));
                copy.setPrompt(copyPrompt);
            } else {
                copy.prompt = null;
            }
            if (this.isSetId()) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof Isindex)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Isindex that = ((Isindex) object);
        {
            String lhsPrompt;
            lhsPrompt = this.getPrompt();
            String rhsPrompt;
            rhsPrompt = that.getPrompt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "prompt", lhsPrompt), LocatorUtils.property(thatLocator, "prompt", rhsPrompt), lhsPrompt, rhsPrompt)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "prompt", thePrompt), currentHashCode, thePrompt);
        }
        {
            String theId;
            theId = this.getId();

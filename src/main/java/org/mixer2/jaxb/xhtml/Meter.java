 ...
 *       &lt;attribute name="form" type="{http://www.w3.org/1999/xhtml}Text" />
 *       &lt;attribute name="value" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *       &lt;attribute name="min" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *       &lt;attribute name="max" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *       &lt;attribute name="low" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *       &lt;attribute name="high" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *       &lt;attribute name="optimum" type="{http://www.w3.org/1999/xhtml}MultiLength" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setOptimum(String value) {
        this.optimum = value;
    }

    public boolean isSetOptimum() {
        return (this.optimum!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theOptimum;
            theOptimum = this.getOptimum();
            strategy.appendField(locator, this, "optimum", buffer, theOptimum);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsOptimum;
            lhsOptimum = this.getOptimum();
            String rhsOptimum;
            rhsOptimum = that.getOptimum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "optimum", lhsOptimum), LocatorUtils.property(thatLocator, "optimum", rhsOptimum), lhsOptimum, rhsOptimum)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theOptimum;
            theOptimum = this.getOptimum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "optimum", theOptimum), currentHashCode, theOptimum);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Meter) {
            final Meter copy = ((Meter) draftCopy);
            if (this.isSetForm()) {
                String sourceForm;
                sourceForm = this.getForm();
                String copyForm = ((String) strategy.copy(LocatorUtils.property(locator, "form", sourceForm), sourceForm));
            ...
            if (this.isSetLow()) {
                ...
                String copyLow = ((String) strategy.copy(LocatorUtils.property(locator, "low", sourceLow), sourceLow));
                copy.setLow(copyLow);
            } else {
                copy.low = null;
            }
            if (this.isSetHigh()) {
                ...
                String copyHigh = ((String) strategy.copy(LocatorUtils.property(locator, "high", sourceHigh), sourceHigh));
                copy.setHigh(copyHigh);
            } else {
                copy.high = null;
            }
            if (this.isSetOptimum()) {
                String sourceOptimum;
                sourceOptimum = this.getOptimum();
                String copyOptimum = ((String) strategy.copy(LocatorUtils.property(locator, "optimum", sourceOptimum), sourceOptimum));
                copy.setOptimum(copyOptimum);
            } else {
                copy.optimum = null;
            }

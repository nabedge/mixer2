    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public List<Inline> getH1OrH2OrH3() {
        if (h1OrH2OrH3 == null) {
            h1OrH2OrH3 = new ArrayList<Inline>();
        }
        return this.h1OrH2OrH3;
    }

    public boolean isSetH1OrH2OrH3() {
        return ((this.h1OrH2OrH3 != null)&&(!this.h1OrH2OrH3 .isEmpty()));
    }

    public void unsetH1OrH2OrH3() {
        this.h1OrH2OrH3 = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Inline> theH1OrH2OrH3;
            theH1OrH2OrH3 = (this.isSetH1OrH2OrH3()?this.getH1OrH2OrH3():null);
            strategy.appendField(locator, this, "h1OrH2OrH3", buffer, theH1OrH2OrH3);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof Hgroup)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Hgroup that = ((Hgroup) object);
        {
            List<Inline> lhsH1OrH2OrH3;
            lhsH1OrH2OrH3 = (this.isSetH1OrH2OrH3()?this.getH1OrH2OrH3():null);
            List<Inline> rhsH1OrH2OrH3;
            rhsH1OrH2OrH3 = (that.isSetH1OrH2OrH3()?that.getH1OrH2OrH3():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "h1OrH2OrH3", lhsH1OrH2OrH3), LocatorUtils.property(thatLocator, "h1OrH2OrH3", rhsH1OrH2OrH3), lhsH1OrH2OrH3, rhsH1OrH2OrH3)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Inline> theH1OrH2OrH3;
            theH1OrH2OrH3 = (this.isSetH1OrH2OrH3()?this.getH1OrH2OrH3():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "h1OrH2OrH3", theH1OrH2OrH3), currentHashCode, theH1OrH2OrH3);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Hgroup) {
            final Hgroup copy = ((Hgroup) draftCopy);
            if (this.isSetH1OrH2OrH3()) {
                List<Inline> sourceH1OrH2OrH3;
                sourceH1OrH2OrH3 = (this.isSetH1OrH2OrH3()?this.getH1OrH2OrH3():null);
                @SuppressWarnings("unchecked")
                List<Inline> copyH1OrH2OrH3 = ((List<Inline> ) strategy.copy(LocatorUtils.property(locator, "h1OrH2OrH3", sourceH1OrH2OrH3), sourceH1OrH2OrH3));
                copy.unsetH1OrH2OrH3();
                if (copyH1OrH2OrH3 != null) {
                    List<Inline> uniqueH1OrH2OrH3l = copy.getH1OrH2OrH3();
                    uniqueH1OrH2OrH3l.addAll(copyH1OrH2OrH3);
                }
            } else {
                copy.unsetH1OrH2OrH3();
            }

 ...
 *       &lt;attribute name="datetime" type="{http://www.w3.org/1999/xhtml}Text" />
 *       &lt;attribute name="pubdate" type="{http://www.w3.org/1999/xhtml}Text" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "pubdate", buffer, thePubdate);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsPubdate;
            lhsPubdate = this.getPubdate();
            String rhsPubdate;
            rhsPubdate = that.getPubdate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "pubdate", lhsPubdate), LocatorUtils.property(thatLocator, "pubdate", rhsPubdate), lhsPubdate, rhsPubdate)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String thePubdate;
            thePubdate = this.getPubdate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "pubdate", thePubdate), currentHashCode, thePubdate);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Time) {
            ...
            if (this.isSetPubdate()) {
                String sourcePubdate;
                sourcePubdate = this.getPubdate();
                String copyPubdate = ((String) strategy.copy(LocatorUtils.property(locator, "pubdate", sourcePubdate), sourcePubdate));
                copy.setPubdate(copyPubdate);
            } else {
                copy.pubdate = null;
            }

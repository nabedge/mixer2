    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected List<AbstractJaxb> optgroupOrOption;
     ...
     * 
     */
    public List<AbstractJaxb> getOptgroupOrOption() {
        if (optgroupOrOption == null) {
            optgroupOrOption = new ArrayList<AbstractJaxb>();
        }
        return this.optgroupOrOption;
    }

    public boolean isSetOptgroupOrOption() {
        return ((this.optgroupOrOption!= null)&&(!this.optgroupOrOption.isEmpty()));
    }

    public void unsetOptgroupOrOption() {
        this.optgroupOrOption = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<AbstractJaxb> theOptgroupOrOption;
            theOptgroupOrOption = (this.isSetOptgroupOrOption()?this.getOptgroupOrOption():null);
            strategy.appendField(locator, this, "optgroupOrOption", buffer, theOptgroupOrOption);
        }
        {
            String theName;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<AbstractJaxb> lhsOptgroupOrOption;
            lhsOptgroupOrOption = (this.isSetOptgroupOrOption()?this.getOptgroupOrOption():null);
            List<AbstractJaxb> rhsOptgroupOrOption;
            rhsOptgroupOrOption = (that.isSetOptgroupOrOption()?that.getOptgroupOrOption():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "optgroupOrOption", lhsOptgroupOrOption), LocatorUtils.property(thatLocator, "optgroupOrOption", rhsOptgroupOrOption), lhsOptgroupOrOption, rhsOptgroupOrOption)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<AbstractJaxb> theOptgroupOrOption;
            theOptgroupOrOption = (this.isSetOptgroupOrOption()?this.getOptgroupOrOption():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "optgroupOrOption", theOptgroupOrOption), currentHashCode, theOptgroupOrOption);
        }
        {
            String theName;
            theName = this.getName();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Select) {
            final Select copy = ((Select) draftCopy);
            if (this.isSetOptgroupOrOption()) {
                List<AbstractJaxb> sourceOptgroupOrOption;
                sourceOptgroupOrOption = (this.isSetOptgroupOrOption()?this.getOptgroupOrOption():null);
                @SuppressWarnings("unchecked")
                List<AbstractJaxb> copyOptgroupOrOption = ((List<AbstractJaxb> ) strategy.copy(LocatorUtils.property(locator, "optgroupOrOption", sourceOptgroupOrOption), sourceOptgroupOrOption));
                copy.unsetOptgroupOrOption();
                if (copyOptgroupOrOption!= null) {
                    List<AbstractJaxb> uniqueOptgroupOrOptionl = copy.getOptgroupOrOption();
                    uniqueOptgroupOrOptionl.addAll(copyOptgroupOrOption);
                }
            } else {
                copy.unsetOptgroupOrOption();
            }
            ...
            if (this.isSetSize()) {
                ...
                Integer copySize = ((Integer) strategy.copy(LocatorUtils.property(locator, "size", sourceSize), sourceSize));

    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            java.lang.Object theFor;
            theFor = this.getFor();
            strategy.appendField(locator, this, "_for", buffer, theFor);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            java.lang.Object lhsFor;
            lhsFor = this.getFor();
            java.lang.Object rhsFor;
            rhsFor = that.getFor();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            java.lang.Object theFor;
            theFor = this.getFor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "_for", theFor), currentHashCode, theFor);
        }
        {
            java.lang.Object theForm;
            theForm = this.getForm();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Label) {
            final Label copy = ((Label) draftCopy);
            if (this.isSetFor()) {
                java.lang.Object sourceFor;
                sourceFor = this.getFor();
                java.lang.Object copyFor = ((java.lang.Object) strategy.copy(LocatorUtils.property(locator, "_for", sourceFor), sourceFor));
                copy.setFor(copyFor);
            } else {
                copy._for = null;
            }

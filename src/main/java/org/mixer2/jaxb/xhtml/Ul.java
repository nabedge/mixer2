 ...
 *       &lt;attribute name="type" type="{http://www.w3.org/1999/xhtml}ULStyle" />
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setType(ULStyle value) {
        this.type = value;
    }
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Ul) {
            final Ul copy = ((Ul) draftCopy);
            if (this.isSetLi()) {
                List<Li> sourceLi;
            ...
            if (this.isSetType()) {
                ...
                ULStyle copyType = ((ULStyle) strategy.copy(LocatorUtils.property(locator, "type", sourceType), sourceType));

    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "main", type = Main.class),
     ...
     * 
     */
    public List<AbstractJaxb> getPOrH1OrH2() {
        if (pOrH1OrH2 == null) {
            pOrH1OrH2 = new ArrayList<AbstractJaxb>();
        }
        return this.pOrH1OrH2;
    }

    public boolean isSetPOrH1OrH2() {
        return ((this.pOrH1OrH2 != null)&&(!this.pOrH1OrH2 .isEmpty()));
    }

    public void unsetPOrH1OrH2() {
        this.pOrH1OrH2 = null;
    }
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Map) {
            final Map copy = ((Map) draftCopy);
            if (this.isSetPOrH1OrH2()) {
                List<AbstractJaxb> sourcePOrH1OrH2;
                sourcePOrH1OrH2 = (this.isSetPOrH1OrH2()?this.getPOrH1OrH2():null);
                @SuppressWarnings("unchecked")
                List<AbstractJaxb> copyPOrH1OrH2 = ((List<AbstractJaxb> ) strategy.copy(LocatorUtils.property(locator, "pOrH1OrH2", sourcePOrH1OrH2), sourcePOrH1OrH2));
                copy.unsetPOrH1OrH2();
                if (copyPOrH1OrH2 != null) {
                    List<AbstractJaxb> uniquePOrH1OrH2l = copy.getPOrH1OrH2();
                    uniquePOrH1OrH2l.addAll(copyPOrH1OrH2);
                }
            } else {
                copy.unsetPOrH1OrH2();
            }
            if (this.isSetArea()) {
                List<Area> sourceArea;
                sourceArea = (this.isSetArea()?this.getArea():null);
                @SuppressWarnings("unchecked")
                List<Area> copyArea = ((List<Area> ) strategy.copy(LocatorUtils.property(locator, "area", sourceArea), sourceArea));
                copy.unsetArea();
                if (copyArea!= null) {
                    List<Area> uniqueAreal = copy.getArea();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<AbstractJaxb> lhsPOrH1OrH2;
            lhsPOrH1OrH2 = (this.isSetPOrH1OrH2()?this.getPOrH1OrH2():null);
            List<AbstractJaxb> rhsPOrH1OrH2;
            rhsPOrH1OrH2 = (that.isSetPOrH1OrH2()?that.getPOrH1OrH2():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "pOrH1OrH2", lhsPOrH1OrH2), LocatorUtils.property(thatLocator, "pOrH1OrH2", rhsPOrH1OrH2), lhsPOrH1OrH2, rhsPOrH1OrH2)) {
                return false;
            }
        }
        {
            List<Area> lhsArea;
            lhsArea = (this.isSetArea()?this.getArea():null);
            List<Area> rhsArea;
            rhsArea = (that.isSetArea()?that.getArea():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<AbstractJaxb> thePOrH1OrH2;
            thePOrH1OrH2 = (this.isSetPOrH1OrH2()?this.getPOrH1OrH2():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "pOrH1OrH2", thePOrH1OrH2), currentHashCode, thePOrH1OrH2);
        }
        {
            List<Area> theArea;
            theArea = (this.isSetArea()?this.getArea():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "area", theArea), currentHashCode, theArea);
        }
        {
            String theName;

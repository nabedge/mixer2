    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            String theClear;
            theClear = this.getClear();
            strategy.appendField(locator, this, "clear", buffer, theClear);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsClear;
            lhsClear = this.getClear();
            String rhsClear;
            rhsClear = that.getClear();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "clear", lhsClear), LocatorUtils.property(thatLocator, "clear", rhsClear), lhsClear, rhsClear)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            String theClear;
            theClear = this.getClear();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "clear", theClear), currentHashCode, theClear);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Br) {
            final Br copy = ((Br) draftCopy);
            if (this.isSetClear()) {
                String sourceClear;
                sourceClear = this.getClear();
                String copyClear = ((String) strategy.copy(LocatorUtils.property(locator, "clear", sourceClear), sourceClear));
                copy.setClear(copyClear);
            } else {
                copy.clear = null;
            }
            if (this.isSetId()) {

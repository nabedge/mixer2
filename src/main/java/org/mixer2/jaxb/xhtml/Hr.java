 ...
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}token">
 *             &lt;enumeration value="noshade"/>
 *           &lt;/restriction>
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="size" type="{http://www.w3.org/1999/xhtml}Pixels" />
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the noshade property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the noshade property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setNoshade(String value) {
        this.noshade = value;
    }

    public boolean isSetNoshade() {
        return (this.noshade!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theNoshade;
            theNoshade = this.getNoshade();
            strategy.appendField(locator, this, "noshade", buffer, theNoshade);
        }
        {
            Integer theSize;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsNoshade;
            lhsNoshade = this.getNoshade();
            String rhsNoshade;
            rhsNoshade = that.getNoshade();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noshade", lhsNoshade), LocatorUtils.property(thatLocator, "noshade", rhsNoshade), lhsNoshade, rhsNoshade)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theNoshade;
            theNoshade = this.getNoshade();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noshade", theNoshade), currentHashCode, theNoshade);
        }
        {
            Integer theSize;
            theSize = this.getSize();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Hr) {
            final Hr copy = ((Hr) draftCopy);
            if (this.isSetAlign()) {
                String sourceAlign;
            ...
            if (this.isSetNoshade()) {
                String sourceNoshade;
                sourceNoshade = this.getNoshade();
                String copyNoshade = ((String) strategy.copy(LocatorUtils.property(locator, "noshade", sourceNoshade), sourceNoshade));
                copy.setNoshade(copyNoshade);
            } else {
                copy.noshade = null;
            }
            if (this.isSetSize()) {

 ...
 *       &lt;attribute name="color" type="{http://www.w3.org/1999/xhtml}Color" />
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof Basefont)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final Basefont that = ((Basefont) object);
        {
            String lhsSize;
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Basefont) {
            final Basefont copy = ((Basefont) draftCopy);
            if (this.isSetSize()) {
                String sourceSize;
            ...
            if (this.isSetFace()) {
                ...
                String copyFace = ((String) strategy.copy(LocatorUtils.property(locator, "face", sourceFace), sourceFace));

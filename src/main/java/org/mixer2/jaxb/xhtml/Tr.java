    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean isSetThOrTd() {
        return ((this.thOrTd!= null)&&(!this.thOrTd.isEmpty()));
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Flow> theThOrTd;
            theThOrTd = (this.isSetThOrTd()?this.getThOrTd():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<Flow> lhsThOrTd;
            lhsThOrTd = (this.isSetThOrTd()?this.getThOrTd():null);
            List<Flow> rhsThOrTd;
            rhsThOrTd = (that.isSetThOrTd()?that.getThOrTd():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "thOrTd", lhsThOrTd), LocatorUtils.property(thatLocator, "thOrTd", rhsThOrTd), lhsThOrTd, rhsThOrTd)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Flow> theThOrTd;
            theThOrTd = (this.isSetThOrTd()?this.getThOrTd():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "thOrTd", theThOrTd), currentHashCode, theThOrTd);
        }
        {
            String theBgcolor;
            theBgcolor = this.getBgcolor();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Tr) {
            final Tr copy = ((Tr) draftCopy);
            if (this.isSetThOrTd()) {
                List<Flow> sourceThOrTd;
                sourceThOrTd = (this.isSetThOrTd()?this.getThOrTd():null);
                @SuppressWarnings("unchecked")
                List<Flow> copyThOrTd = ((List<Flow> ) strategy.copy(LocatorUtils.property(locator, "thOrTd", sourceThOrTd), sourceThOrTd));
                copy.unsetThOrTd();
                if (copyThOrTd!= null) {
                    List<Flow> uniqueThOrTdl = copy.getThOrTd();
                    uniqueThOrTdl.addAll(copyThOrTd);
                }
            } else {
                copy.unsetThOrTd();
            }

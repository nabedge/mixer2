    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected List<AbstractJaxb> dtOrDd;
     ...
     * 
     */
    public List<AbstractJaxb> getDtOrDd() {
        if (dtOrDd == null) {
            dtOrDd = new ArrayList<AbstractJaxb>();
        }
        return this.dtOrDd;
    }

    public boolean isSetDtOrDd() {
        return ((this.dtOrDd!= null)&&(!this.dtOrDd.isEmpty()));
    }

    public void unsetDtOrDd() {
        this.dtOrDd = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<AbstractJaxb> theDtOrDd;
            theDtOrDd = (this.isSetDtOrDd()?this.getDtOrDd():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<AbstractJaxb> lhsDtOrDd;
            lhsDtOrDd = (this.isSetDtOrDd()?this.getDtOrDd():null);
            List<AbstractJaxb> rhsDtOrDd;
            rhsDtOrDd = (that.isSetDtOrDd()?that.getDtOrDd():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dtOrDd", lhsDtOrDd), LocatorUtils.property(thatLocator, "dtOrDd", rhsDtOrDd), lhsDtOrDd, rhsDtOrDd)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<AbstractJaxb> theDtOrDd;
            theDtOrDd = (this.isSetDtOrDd()?this.getDtOrDd():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dtOrDd", theDtOrDd), currentHashCode, theDtOrDd);
        }
        {
            String theCompact;
            theCompact = this.getCompact();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Dl) {
            final Dl copy = ((Dl) draftCopy);
            if (this.isSetDtOrDd()) {
                List<AbstractJaxb> sourceDtOrDd;
                sourceDtOrDd = (this.isSetDtOrDd()?this.getDtOrDd():null);
                @SuppressWarnings("unchecked")
                List<AbstractJaxb> copyDtOrDd = ((List<AbstractJaxb> ) strategy.copy(LocatorUtils.property(locator, "dtOrDd", sourceDtOrDd), sourceDtOrDd));
                copy.unsetDtOrDd();
                if (copyDtOrDd!= null) {
                    List<AbstractJaxb> uniqueDtOrDdl = copy.getDtOrDd();
                    uniqueDtOrDdl.addAll(copyDtOrDd);
                }
            } else {
                copy.unsetDtOrDd();
            }

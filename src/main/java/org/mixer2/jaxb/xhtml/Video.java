    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsPoster;
            lhsPoster = this.getPoster();
            String rhsPoster;
            rhsPoster = that.getPoster();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "poster", lhsPoster), LocatorUtils.property(thatLocator, "poster", rhsPoster), lhsPoster, rhsPoster)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            String thePoster;
            thePoster = this.getPoster();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "poster", thePoster), currentHashCode, thePoster);
        }
        {
            Integer theWidth;
            theWidth = this.getWidth();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Video) {
            ...
            if (this.isSetPoster()) {
                String sourcePoster;
                sourcePoster = this.getPoster();
                String copyPoster = ((String) strategy.copy(LocatorUtils.property(locator, "poster", sourcePoster), sourcePoster));
                copy.setPoster(copyPoster);
            } else {
                copy.poster = null;
            }
            if (this.isSetWidth()) {

    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "head", buffer, theHead);
        }
        {
            Body theBody;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "manifest", buffer, theManifest);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Html) {
            final Html copy = ((Html) draftCopy);
            if (this.isSetHead()) {
                Head sourceHead;
                sourceHead = this.getHead();
                Head copyHead = ((Head) strategy.copy(LocatorUtils.property(locator, "head", sourceHead), sourceHead));
            ...
            if (this.isSetBody()) {
                ...
                Body copyBody = ((Body) strategy.copy(LocatorUtils.property(locator, "body", sourceBody), sourceBody));
                copy.setBody(copyBody);
            } else {
                copy.body = null;
            }
            if (this.isSetManifest()) {
                String sourceManifest;
                sourceManifest = this.getManifest();
                String copyManifest = ((String) strategy.copy(LocatorUtils.property(locator, "manifest", sourceManifest), sourceManifest));
                copy.setManifest(copyManifest);
            } else {
                copy.manifest = null;
            }
            if (this.isSetId()) {

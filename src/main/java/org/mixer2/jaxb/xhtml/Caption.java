 ...
 *       &lt;attribute name="align" type="{http://www.w3.org/1999/xhtml}CAlign" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
     ...
     *     
     */
    public void setAlign(CAlign value) {
        this.align = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Caption that = ((Caption) object);
        {
            CAlign lhsAlign;
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Caption) {
            final Caption copy = ((Caption) draftCopy);
            if (this.isSetAlign()) {
                CAlign sourceAlign;
                sourceAlign = this.getAlign();
                CAlign copyAlign = ((CAlign) strategy.copy(LocatorUtils.property(locator, "align", sourceAlign), sourceAlign));

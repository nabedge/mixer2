 ...
 *       &lt;attribute name="sandbox" type="{http://www.w3.org/2001/XMLSchema}NMTOKENS" />
 *       &lt;attribute name="src" type="{http://www.w3.org/1999/xhtml}URI" />
 *       &lt;attribute name="srcdoc" type="{http://www.w3.org/1999/xhtml}Text" />
 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="marginwidth" type="{http://www.w3.org/1999/xhtml}Pixels" />
 *       &lt;attribute name="marginheight" type="{http://www.w3.org/1999/xhtml}Pixels" />
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected List<String> sandbox;
    @XmlAttribute(name = "src")
    protected String src;
    @XmlAttribute(name = "srcdoc")
    ...
    public List<String> getSandbox() {
        if (sandbox == null) {
            sandbox = new ArrayList<String>();
        }
        return this.sandbox;
    }

    public boolean isSetSandbox() {
        return ((this.sandbox!= null)&&(!this.sandbox.isEmpty()));
    }
    ...
    public boolean isSetFrameborder() {
        return (this.frameborder!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<String> theSandbox;
            theSandbox = (this.isSetSandbox()?this.getSandbox():null);
        ...
        {
            String theSrcdoc;
            theSrcdoc = this.getSrcdoc();
            strategy.appendField(locator, this, "srcdoc", buffer, theSrcdoc);
        }
        {
            String theSeamless;
            theSeamless = this.getSeamless();
            strategy.appendField(locator, this, "seamless", buffer, theSeamless);
        }
        {
            String theFrameborder;
            theFrameborder = this.getFrameborder();
            strategy.appendField(locator, this, "frameborder", buffer, theFrameborder);
        }
        {
            Integer theMarginwidth;
            theMarginwidth = this.getMarginwidth();
            strategy.appendField(locator, this, "marginwidth", buffer, theMarginwidth);
        }
        {
            Integer theMarginheight;
            theMarginheight = this.getMarginheight();
            strategy.appendField(locator, this, "marginheight", buffer, theMarginheight);
        }
        {
            String theScrolling;
            theScrolling = this.getScrolling();
            strategy.appendField(locator, this, "scrolling", buffer, theScrolling);
        }
        {
            ImgAlign theAlign;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Iframe that = ((Iframe) object);
        {
            String lhsLongdesc;
        ...
        {
            List<String> lhsSandbox;
            lhsSandbox = (this.isSetSandbox()?this.getSandbox():null);
            List<String> rhsSandbox;
            rhsSandbox = (that.isSetSandbox()?that.getSandbox():null);
        ...
        {
            String lhsSrcdoc;
            lhsSrcdoc = this.getSrcdoc();
            String rhsSrcdoc;
            rhsSrcdoc = that.getSrcdoc();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "srcdoc", lhsSrcdoc), LocatorUtils.property(thatLocator, "srcdoc", rhsSrcdoc), lhsSrcdoc, rhsSrcdoc)) {
                return false;
            }
        }
        {
            String lhsSeamless;
            lhsSeamless = this.getSeamless();
            String rhsSeamless;
            rhsSeamless = that.getSeamless();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "seamless", lhsSeamless), LocatorUtils.property(thatLocator, "seamless", rhsSeamless), lhsSeamless, rhsSeamless)) {
                return false;
            }
        }
        {
            String lhsFrameborder;
            lhsFrameborder = this.getFrameborder();
            String rhsFrameborder;
            rhsFrameborder = that.getFrameborder();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "frameborder", lhsFrameborder), LocatorUtils.property(thatLocator, "frameborder", rhsFrameborder), lhsFrameborder, rhsFrameborder)) {
                return false;
            }
        }
        {
            Integer lhsMarginwidth;
            lhsMarginwidth = this.getMarginwidth();
            Integer rhsMarginwidth;
            rhsMarginwidth = that.getMarginwidth();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "marginwidth", lhsMarginwidth), LocatorUtils.property(thatLocator, "marginwidth", rhsMarginwidth), lhsMarginwidth, rhsMarginwidth)) {
                return false;
            }
        }
        {
            Integer lhsMarginheight;
            lhsMarginheight = this.getMarginheight();
            Integer rhsMarginheight;
            rhsMarginheight = that.getMarginheight();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "marginheight", lhsMarginheight), LocatorUtils.property(thatLocator, "marginheight", rhsMarginheight), lhsMarginheight, rhsMarginheight)) {
                return false;
            }
        }
        {
            String lhsScrolling;
            lhsScrolling = this.getScrolling();
            String rhsScrolling;
            rhsScrolling = that.getScrolling();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scrolling", lhsScrolling), LocatorUtils.property(thatLocator, "scrolling", rhsScrolling), lhsScrolling, rhsScrolling)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theSrcdoc;
            theSrcdoc = this.getSrcdoc();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "srcdoc", theSrcdoc), currentHashCode, theSrcdoc);
        }
        {
            String theSeamless;
            theSeamless = this.getSeamless();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "seamless", theSeamless), currentHashCode, theSeamless);
        }
        {
            String theFrameborder;
            theFrameborder = this.getFrameborder();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "frameborder", theFrameborder), currentHashCode, theFrameborder);
        }
        {
            Integer theMarginwidth;
            theMarginwidth = this.getMarginwidth();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "marginwidth", theMarginwidth), currentHashCode, theMarginwidth);
        }
        {
            Integer theMarginheight;
            theMarginheight = this.getMarginheight();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "marginheight", theMarginheight), currentHashCode, theMarginheight);
        }
        {
            String theScrolling;
            theScrolling = this.getScrolling();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scrolling", theScrolling), currentHashCode, theScrolling);
        }
        {
            ImgAlign theAlign;
            theAlign = this.getAlign();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Iframe) {
            final Iframe copy = ((Iframe) draftCopy);
            ...
            if (this.isSetSandbox()) {
                List<String> sourceSandbox;
                sourceSandbox = (this.isSetSandbox()?this.getSandbox():null);
                @SuppressWarnings("unchecked")
                List<String> copySandbox = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "sandbox", sourceSandbox), sourceSandbox));
                copy.unsetSandbox();
                if (copySandbox!= null) {
                    List<String> uniqueSandboxl = copy.getSandbox();
                    uniqueSandboxl.addAll(copySandbox);
                }
            } else {
                copy.unsetSandbox();
            }
            ...
            if (this.isSetSrcdoc()) {
                String sourceSrcdoc;
                sourceSrcdoc = this.getSrcdoc();
                String copySrcdoc = ((String) strategy.copy(LocatorUtils.property(locator, "srcdoc", sourceSrcdoc), sourceSrcdoc));
                copy.setSrcdoc(copySrcdoc);
            } else {
                copy.srcdoc = null;
            }
            if (this.isSetSeamless()) {
                String sourceSeamless;
                sourceSeamless = this.getSeamless();
                String copySeamless = ((String) strategy.copy(LocatorUtils.property(locator, "seamless", sourceSeamless), sourceSeamless));
                copy.setSeamless(copySeamless);
            } else {
                copy.seamless = null;
            }
            if (this.isSetFrameborder()) {
                String sourceFrameborder;
                sourceFrameborder = this.getFrameborder();
                String copyFrameborder = ((String) strategy.copy(LocatorUtils.property(locator, "frameborder", sourceFrameborder), sourceFrameborder));
                copy.setFrameborder(copyFrameborder);
            } else {
                copy.frameborder = null;
            }
            if (this.isSetMarginwidth()) {
                Integer sourceMarginwidth;
                sourceMarginwidth = this.getMarginwidth();
                Integer copyMarginwidth = ((Integer) strategy.copy(LocatorUtils.property(locator, "marginwidth", sourceMarginwidth), sourceMarginwidth));
                copy.setMarginwidth(copyMarginwidth);
            } else {
                copy.marginwidth = null;
            }
            if (this.isSetMarginheight()) {
                Integer sourceMarginheight;
                sourceMarginheight = this.getMarginheight();
                Integer copyMarginheight = ((Integer) strategy.copy(LocatorUtils.property(locator, "marginheight", sourceMarginheight), sourceMarginheight));
                copy.setMarginheight(copyMarginheight);
            } else {
                copy.marginheight = null;
            }
            if (this.isSetScrolling()) {
                String sourceScrolling;
                sourceScrolling = this.getScrolling();
                String copyScrolling = ((String) strategy.copy(LocatorUtils.property(locator, "scrolling", sourceScrolling), sourceScrolling));
                copy.setScrolling(copyScrolling);
            } else {
                copy.scrolling = null;
            }
            if (this.isSetAlign()) {

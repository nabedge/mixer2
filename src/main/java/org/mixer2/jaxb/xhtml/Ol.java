 ...
 *       &lt;attribute name="type" type="{http://www.w3.org/1999/xhtml}OLStyle" />
 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="start" type="{http://www.w3.org/1999/xhtml}Number" />
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean isSetLi() {
        return ((this.li!= null)&&(!this.li.isEmpty()));
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Li> theLi;
            theLi = (this.isSetLi()?this.getLi():null);
        ...
        {
            String theCompact;
            theCompact = this.getCompact();
            strategy.appendField(locator, this, "compact", buffer, theCompact);
        }
        {
            Integer theStart;
        ...
        {
            String theReversed;
            theReversed = this.getReversed();
            strategy.appendField(locator, this, "reversed", buffer, theReversed);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        final Ol that = ((Ol) object);
        {
            List<Li> lhsLi;
            lhsLi = (this.isSetLi()?this.getLi():null);
            List<Li> rhsLi;
            rhsLi = (that.isSetLi()?that.getLi():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "li", lhsLi), LocatorUtils.property(thatLocator, "li", rhsLi), lhsLi, rhsLi)) {
                return false;
            }
        }
        {
        ...
        {
            String lhsCompact;
            lhsCompact = this.getCompact();
            String rhsCompact;
            rhsCompact = that.getCompact();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "compact", lhsCompact), LocatorUtils.property(thatLocator, "compact", rhsCompact), lhsCompact, rhsCompact)) {
                return false;
            }
        }
        {
        ...
        {
            String lhsReversed;
            lhsReversed = this.getReversed();
            String rhsReversed;
            rhsReversed = that.getReversed();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "reversed", lhsReversed), LocatorUtils.property(thatLocator, "reversed", rhsReversed), lhsReversed, rhsReversed)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Li> theLi;
            theLi = (this.isSetLi()?this.getLi():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "li", theLi), currentHashCode, theLi);
        }
        {
            String theType;
            theType = this.getType();
        ...
        }
        {
            String theCompact;
            theCompact = this.getCompact();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "compact", theCompact), currentHashCode, theCompact);
        }
        {
            Integer theStart;
            theStart = this.getStart();
        ...
        }
        {
            String theReversed;
            theReversed = this.getReversed();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "reversed", theReversed), currentHashCode, theReversed);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Ol) {
            final Ol copy = ((Ol) draftCopy);
            if (this.isSetLi()) {
                List<Li> sourceLi;
                sourceLi = (this.isSetLi()?this.getLi():null);
                @SuppressWarnings("unchecked")
                List<Li> copyLi = ((List<Li> ) strategy.copy(LocatorUtils.property(locator, "li", sourceLi), sourceLi));
                copy.unsetLi();
                if (copyLi!= null) {
                    List<Li> uniqueLil = copy.getLi();
                    uniqueLil.addAll(copyLi);
                }
            } else {
                copy.unsetLi();
            }
            ...
            if (this.isSetCompact()) {
                String sourceCompact;
                sourceCompact = this.getCompact();
                String copyCompact = ((String) strategy.copy(LocatorUtils.property(locator, "compact", sourceCompact), sourceCompact));
                copy.setCompact(copyCompact);
            } else {
                copy.compact = null;
            }
            if (this.isSetStart()) {
                ...
                Integer copyStart = ((Integer) strategy.copy(LocatorUtils.property(locator, "start", sourceStart), sourceStart));
                copy.setStart(copyStart);
            } else {
                copy.start = null;
            }
            if (this.isSetReversed()) {
                String sourceReversed;
                sourceReversed = this.getReversed();
                String copyReversed = ((String) strategy.copy(LocatorUtils.property(locator, "reversed", sourceReversed), sourceReversed));
                copy.setReversed(copyReversed);
            } else {
                copy.reversed = null;
            }

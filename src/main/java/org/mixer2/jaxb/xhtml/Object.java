    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "declare", buffer, theDeclare);
        }
        {
            String theClassid;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "codetype", buffer, theCodetype);
        }
        {
            String theArchive;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "standby", buffer, theStandby);
        }
        {
            String theHeight;

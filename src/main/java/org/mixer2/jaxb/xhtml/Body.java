 ...
 *       &lt;attribute name="background" type="{http://www.w3.org/1999/xhtml}URI" />
 *       &lt;attribute name="bgcolor" type="{http://www.w3.org/1999/xhtml}Color" />
 *       &lt;attribute name="text" type="{http://www.w3.org/1999/xhtml}Color" />
 *       &lt;attribute name="link" type="{http://www.w3.org/1999/xhtml}Color" />
 *       &lt;attribute name="vlink" type="{http://www.w3.org/1999/xhtml}Color" />
 *       &lt;attribute name="alink" type="{http://www.w3.org/1999/xhtml}Color" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlAttribute(name = "vlink")
    protected String vlink;
    @XmlAttribute(name = "alink")
    ...
    public boolean isSetOnunload() {
        return (this.onunload!= null);
    }

    /**
     * backgroundプロパティの値を取得します。
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    public boolean isSetVlink() {
        return (this.vlink!= null);
    }
    ...
    public boolean isSetAlink() {
        return (this.alink!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theOnunload;
            theOnunload = this.getOnunload();
            strategy.appendField(locator, this, "onunload", buffer, theOnunload);
        }
        {
        ...
        {
            String theVlink;
            theVlink = this.getVlink();
            strategy.appendField(locator, this, "vlink", buffer, theVlink);
        }
        {
            String theAlink;
            theAlink = this.getAlink();
            strategy.appendField(locator, this, "alink", buffer, theAlink);
        }
        {
            String theOnclick;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsOnunload;
            lhsOnunload = this.getOnunload();
            String rhsOnunload;
            rhsOnunload = that.getOnunload();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "onunload", lhsOnunload), LocatorUtils.property(thatLocator, "onunload", rhsOnunload), lhsOnunload, rhsOnunload)) {
                return false;
            }
        }
        {
        ...
        {
            String lhsVlink;
            lhsVlink = this.getVlink();
            String rhsVlink;
            rhsVlink = that.getVlink();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "vlink", lhsVlink), LocatorUtils.property(thatLocator, "vlink", rhsVlink), lhsVlink, rhsVlink)) {
                return false;
            }
        }
        {
            String lhsAlink;
            lhsAlink = this.getAlink();
            String rhsAlink;
            rhsAlink = that.getAlink();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "alink", lhsAlink), LocatorUtils.property(thatLocator, "alink", rhsAlink), lhsAlink, rhsAlink)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            String theOnunload;
            theOnunload = this.getOnunload();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "onunload", theOnunload), currentHashCode, theOnunload);
        }
        {
            String theBackground;
            theBackground = this.getBackground();
        ...
        }
        {
            String theVlink;
            theVlink = this.getVlink();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "vlink", theVlink), currentHashCode, theVlink);
        }
        {
            String theAlink;
            theAlink = this.getAlink();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "alink", theAlink), currentHashCode, theAlink);
        }
        {
            String theOnclick;
            theOnclick = this.getOnclick();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Body) {
            final Body copy = ((Body) draftCopy);
            if (this.isSetOnunload()) {
                String sourceOnunload;
                sourceOnunload = this.getOnunload();
                String copyOnunload = ((String) strategy.copy(LocatorUtils.property(locator, "onunload", sourceOnunload), sourceOnunload));
                copy.setOnunload(copyOnunload);
            } else {
                copy.onunload = null;
            }
            ...
            if (this.isSetLink()) {
                ...
                String copyLink = ((String) strategy.copy(LocatorUtils.property(locator, "link", sourceLink), sourceLink));
            ...
            if (this.isSetVlink()) {
                String sourceVlink;
                sourceVlink = this.getVlink();
                String copyVlink = ((String) strategy.copy(LocatorUtils.property(locator, "vlink", sourceVlink), sourceVlink));
                copy.setVlink(copyVlink);
            } else {
                copy.vlink = null;
            }
            if (this.isSetAlink()) {
                String sourceAlink;
                sourceAlink = this.getAlink();
                String copyAlink = ((String) strategy.copy(LocatorUtils.property(locator, "alink", sourceAlink), sourceAlink));
                copy.setAlink(copyAlink);
            } else {
                copy.alink = null;
            }

    ...
    implements Cloneable, CopyTo, Equals, HashCode
{
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Colgroup) {
            final Colgroup copy = ((Colgroup) draftCopy);
            if (this.isSetCol()) {
                List<Col> sourceCol;
            ...
            if (this.isSetSpan()) {
                int sourceSpan;
                sourceSpan = (this.isSetSpan()?this.getSpan(): 0);
                int copySpan = strategy.copy(LocatorUtils.property(locator, "span", sourceSpan), sourceSpan);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            int lhsSpan;
            lhsSpan = (this.isSetSpan()?this.getSpan(): 0);
            int rhsSpan;
            rhsSpan = (that.isSetSpan()?that.getSpan(): 0);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            int theSpan;
            theSpan = (this.isSetSpan()?this.getSpan(): 0);

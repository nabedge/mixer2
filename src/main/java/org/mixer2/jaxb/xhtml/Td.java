    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<java.lang.Object> theHeaders;
            theHeaders = (this.isSetHeaders()?this.getHeaders():null);
        ...
        {
            int theRowspan;
            theRowspan = (this.isSetRowspan()?this.getRowspan(): 0);
            strategy.appendField(locator, this, "rowspan", buffer, theRowspan);
        }
        {
            int theColspan;
            theColspan = (this.isSetColspan()?this.getColspan(): 0);
            strategy.appendField(locator, this, "colspan", buffer, theColspan);
        }
        {
            String theNowrap;
            theNowrap = this.getNowrap();
            strategy.appendField(locator, this, "nowrap", buffer, theNowrap);
        }
        {
            String theBgcolor;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<java.lang.Object> lhsHeaders;
            lhsHeaders = (this.isSetHeaders()?this.getHeaders():null);
            List<java.lang.Object> rhsHeaders;
            rhsHeaders = (that.isSetHeaders()?that.getHeaders():null);
        ...
        {
            int lhsRowspan;
            lhsRowspan = (this.isSetRowspan()?this.getRowspan(): 0);
            int rhsRowspan;
            rhsRowspan = (that.isSetRowspan()?that.getRowspan(): 0);
        ...
        {
            int lhsColspan;
            lhsColspan = (this.isSetColspan()?this.getColspan(): 0);
            int rhsColspan;
            rhsColspan = (that.isSetColspan()?that.getColspan(): 0);
        ...
        {
            String lhsNowrap;
            lhsNowrap = this.getNowrap();
            String rhsNowrap;
            rhsNowrap = that.getNowrap();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nowrap", lhsNowrap), LocatorUtils.property(thatLocator, "nowrap", rhsNowrap), lhsNowrap, rhsNowrap)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theNowrap;
            theNowrap = this.getNowrap();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nowrap", theNowrap), currentHashCode, theNowrap);
        }
        {
            String theBgcolor;
            theBgcolor = this.getBgcolor();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Td) {
            final Td copy = ((Td) draftCopy);
            if (this.isSetAbbr()) {
                String sourceAbbr;
                sourceAbbr = this.getAbbr();
                String copyAbbr = ((String) strategy.copy(LocatorUtils.property(locator, "abbr", sourceAbbr), sourceAbbr));
                copy.setAbbr(copyAbbr);
            } else {
                copy.abbr = null;
            }
            if (this.isSetAxis()) {
            ...
            if (this.isSetHeaders()) {
                List<java.lang.Object> sourceHeaders;
                sourceHeaders = (this.isSetHeaders()?this.getHeaders():null);
                @SuppressWarnings("unchecked")
                List<java.lang.Object> copyHeaders = ((List<java.lang.Object> ) strategy.copy(LocatorUtils.property(locator, "headers", sourceHeaders), sourceHeaders));
                copy.unsetHeaders();
                if (copyHeaders!= null) {
                    List<java.lang.Object> uniqueHeadersl = copy.getHeaders();
                    uniqueHeadersl.addAll(copyHeaders);
                }
            } else {
                copy.unsetHeaders();
            }
            if (this.isSetScope()) {
                ...
                Scope copyScope = ((Scope) strategy.copy(LocatorUtils.property(locator, "scope", sourceScope), sourceScope));
                copy.setScope(copyScope);
            } else {
                copy.scope = null;
            }
            if (this.isSetRowspan()) {
                int sourceRowspan;
                sourceRowspan = (this.isSetRowspan()?this.getRowspan(): 0);
                int copyRowspan = strategy.copy(LocatorUtils.property(locator, "rowspan", sourceRowspan), sourceRowspan);
                copy.setRowspan(copyRowspan);
            } else {
                copy.rowspan = null;
            }
            if (this.isSetColspan()) {
                int sourceColspan;
                sourceColspan = (this.isSetColspan()?this.getColspan(): 0);
                int copyColspan = strategy.copy(LocatorUtils.property(locator, "colspan", sourceColspan), sourceColspan);
            ...
            if (this.isSetNowrap()) {
                String sourceNowrap;
                sourceNowrap = this.getNowrap();
                String copyNowrap = ((String) strategy.copy(LocatorUtils.property(locator, "nowrap", sourceNowrap), sourceNowrap));
                copy.setNowrap(copyNowrap);
            } else {
                copy.nowrap = null;
            }

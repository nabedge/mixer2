    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        if (!(object instanceof Blockquote)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final Blockquote that = ((Blockquote) object);
        {
            String lhsCite;
            lhsCite = this.getCite();
            String rhsCite;
            rhsCite = that.getCite();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cite", lhsCite), LocatorUtils.property(thatLocator, "cite", rhsCite), lhsCite, rhsCite)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            String theCite;
            theCite = this.getCite();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cite", theCite), currentHashCode, theCite);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Blockquote) {
            final Blockquote copy = ((Blockquote) draftCopy);
            if (this.isSetCite()) {
                String sourceCite;
                sourceCite = this.getCite();
                String copyCite = ((String) strategy.copy(LocatorUtils.property(locator, "cite", sourceCite), sourceCite));
                copy.setCite(copyCite);
            } else {
                copy.cite = null;
            }
            if (this.isSetId()) {

 ...
 *       &lt;attribute name="sizes" type="{http://www.w3.org/2001/XMLSchema}NMTOKENS" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<String> theRev;
            theRev = (this.isSetRev()?this.getRev():null);
        ...
        {
            List<String> theSizes;
            theSizes = (this.isSetSizes()?this.getSizes():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, java.lang.Object object, EqualsStrategy strategy) {
        ...
        {
            List<String> lhsRev;
            lhsRev = (this.isSetRev()?this.getRev():null);
            List<String> rhsRev;
            rhsRev = (that.isSetRev()?that.getRev():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rev", lhsRev), LocatorUtils.property(thatLocator, "rev", rhsRev), lhsRev, rhsRev)) {
                return false;
            }
        }
        {
        ...
        {
            List<String> lhsSizes;
            lhsSizes = (this.isSetSizes()?this.getSizes():null);
            List<String> rhsSizes;
            rhsSizes = (that.isSetSizes()?that.getSizes():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<String> theRev;
            theRev = (this.isSetRev()?this.getRev():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "rev", theRev), currentHashCode, theRev);
        }
        {
            String theMedia;
            theMedia = this.getMedia();
    ...
    public java.lang.Object copyTo(ObjectLocator locator, java.lang.Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Link) {
            ...
            if (this.isSetCharset()) {
                ...
                sourceCharset = this.getCharset();
                String copyCharset = ((String) strategy.copy(LocatorUtils.property(locator, "charset", sourceCharset), sourceCharset));
                copy.setCharset(copyCharset);
            } else {
                copy.charset = null;
            }
            if (this.isSetHref()) {
            ...
            if (this.isSetRev()) {
                List<String> sourceRev;
                sourceRev = (this.isSetRev()?this.getRev():null);
                @SuppressWarnings("unchecked")
                List<String> copyRev = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "rev", sourceRev), sourceRev));
                copy.unsetRev();
                if (copyRev!= null) {
                    List<String> uniqueRevl = copy.getRev();
                    uniqueRevl.addAll(copyRev);
                }
            } else {
                copy.unsetRev();
            }
            ...
            if (this.isSetSizes()) {
                List<String> sourceSizes;
                sourceSizes = (this.isSetSizes()?this.getSizes():null);
                @SuppressWarnings("unchecked")
                List<String> copySizes = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "sizes", sourceSizes), sourceSizes));
                copy.unsetSizes();
                if (copySizes!= null) {
                    List<String> uniqueSizesl = copy.getSizes();
                    uniqueSizesl.addAll(copySizes);
                }
            } else {
                copy.unsetSizes();
            }
